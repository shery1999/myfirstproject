                                ...
                                <div class="card-body">
                                    <form action="registerindex.php" method="post">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <?php session_start(); ?>
                                                    <span> <?php if (isset($_SESSION['name_error'])) {
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <span> <?php if (isset($_SESSION['email_error'])) {
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid">
                                                <button name="submit" type="submit" class="btn btn-primary btn-block" href="login.php">Create Account</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
